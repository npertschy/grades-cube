...
export async function createSubjectForSchoolYear(subject: Subject, schoolYear: SchoolYear): Promise<void> {
  ...
  if (existingSubjects.length === 0) {
    ...
    await db.execute("INSERT INTO ZSUBJECT (Z_PK, Z_ENT, ZNAME) VALUES ($1, $2, $3)", [id, 7, subject.name]);
    await db.execute("INSERT INTO Z_7YEARS (Z_7SUBJECTS, Z_8YEARS2) VALUES ($1, $2)", [id, schoolYear.id]);
    ...
    await db.execute("INSERT INTO Z_7YEARS (Z_7SUBJECTS, Z_8YEARS2) VALUES ($1, $2)", [
